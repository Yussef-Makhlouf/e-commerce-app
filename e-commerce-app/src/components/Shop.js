  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Set products and categories to state
                ...
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      <div>
                        <Badge bg="primary">{product.rating.rate.toFixed(1)} Stars</Badge>
                      </div>
...
//         selectedCategory.length === 0 || selectedCategory.includes(product.category);
//       const matchesPrice = product.price >= minPrice && product.price <= maxPrice;
//       const matchesRating = product.rating.rate >= selectedRating; // Updated to use product.rating.rate
//       return matchesSearch && matchesCategory && matchesPrice && matchesRating;
//     });
//   }, [searchTerm, selectedCategory, minPrice, maxPrice, selectedRating, products]);
...
//                     <div className="d-flex justify-content-between align-items-center">
//                       <div>
//                         <Badge bg="primary">{product.rating.rate.toFixed(1)} Stars</Badge> {/* Updated to product.rating.rate */}
//                       </div>
//                       <div className="text-lg font-weight-bold">${product.price.toFixed(2)}</div>
//                     </div>
//                     <Button variant="primary" className="mt-2 w-100">Buy Now</Button>
